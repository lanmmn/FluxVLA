...
def main():
    ...
    test_end_to_end(
        ...
        obs={
            "cam_high": np.random.randint(0, 255, (256, 256, 3), dtype=np.uint8),
            "cam_left_wrist": np.random.randint(0, 255, (256, 256, 3), dtype=np.uint8),
            "cam_right_wrist": np.random.randint(0, 255, (256, 256, 3), dtype=np.uint8),
            "qpos": np.random.randn(14).astype(np.float32),
            "task_description": "pick up the brown bird toy",
            "unnorm_key": "private",
        },
    ...
    test_end_to_end(
        ...
        obs={
            ...
            "robot0_gripper_qpos": np.array([0.04], dtype=np.float32),
