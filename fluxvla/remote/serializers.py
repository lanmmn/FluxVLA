...
# =========================================================================
# Protobuf observation serializer (mirrors ObsSerializer for msgpack)
# =========================================================================
...
# =========================================================================
# Wire-format encode / decode helpers (predict_action hot path only)
# =========================================================================
def encode_predict_request(
    ...
    """Encode a predict_action request in the chosen wire format."""
    if fmt == 'protobuf':
        from .proto import vla_service_pb2 as pb

        req = pb.PredictActionRequest()
        req.obs.CopyFrom(ObsSerializerProto.obs_to_proto(obs))
...
def encode_predict_response(
    ...
    """Encode a predict_action response in the given wire format."""
    if fmt == FORMAT_PROTOBUF:
        from .proto import vla_service_pb2 as pb
