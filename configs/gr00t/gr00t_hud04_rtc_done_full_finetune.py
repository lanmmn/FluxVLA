...
inference_model = dict(
    ...
    vlm_backbone=dict(
        ...
        vlm_path=  # noqa: E251
        'fluxvla/models/third_party_models/eagle2_hg_model',
        vlm_config=dict(max_input_seq_len=580)),
    vla_head=dict(
        type='FlowMatchingHead',
        state_dim=64,
        hidden_size=1024,
    ...
    dataset=dict(
        ...
        datasets=[
            dict(
                ...
                '/data3/vector/datasets/wbt_done_dim_0509_idle_trim',
                transforms=[
                    dict(
            ...
            dict(
                type='ParquetDataset',
                data_root_path=  # noqa: E251
                '/data3/vector/datasets/wbt_done_dim_0508_0511',
                transforms=[
                    dict(
                        type='ProcessParquetInputs',
                        embodiment_id=0,
            ...
            dict(
                type='ParquetDataset',
                data_root_path=  # noqa: E251
                '/data3/vector/datasets/wbt_done_dim_0512_0514',
                transforms=[
                    dict(
                        type='ProcessParquetInputs',
                        embodiment_id=0,
            ...
            dict(
                type='ParquetDataset',
                data_root_path=  # noqa: E251
                '/data3/vector/datasets/wbt_done_dim_0515',
                transforms=[
                    dict(
                        type='ProcessParquetInputs',
                        embodiment_id=0,
            ...
            dict(
                type='ParquetDataset',
                data_root_path=  # noqa: E251
                '/data3/vector/datasets/wbt_done_dim_0516',
                transforms=[
                    dict(
                        type='ProcessParquetInputs',
                        embodiment_id=0,
