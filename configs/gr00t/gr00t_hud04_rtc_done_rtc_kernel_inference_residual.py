...
"""Two-camera done-dim WBT inference for the residual 4-to-2 student."""
...
# Match the training/deployment conditions used by the new student.
...
# Match the teacher deployment fallback while physical hand feedback is
# unavailable: use the most recently executed model hand action as state.
...
inference_model['vla_head'].update(
    type='ResidualFlowMatchingInferenceHead',
    num_inference_timesteps=2,
    residual_hidden_dim=256,
    residual_max_abs=0.1,
    continuous_action_dim=40,
