    ...
    dataset=dict(
        ...
        datasets=[
            dict(
                ...
                [
                    '/limx_embop/tos/limx_mani_data/raw_data/RealRobot_UR3_lerobot_v2_bbox_debug/20250904_yologripper_debug/20250904_yologripper_debug',  # noqa: E501
                ],
                transforms=[
                    dict(
...
runner = dict(
    ...
    metric=dict(
        ...
        run_dir='work_dirs/gr00t_eagle_3b_ur3_yologripper_bbox_debug',
