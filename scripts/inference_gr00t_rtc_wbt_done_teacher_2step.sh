#!/usr/bin/env bash
# Launch the done-dim teacher directly at two steps for all eight WBT prompts.
...
export CONFIG="${CONFIG:-$FLUXVLA_ROOT/configs/gr00t/gr00t_hud04_rtc_done_rtc_kernel_inference_2step.py}"
